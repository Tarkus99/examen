...
export const CurrentInfoDetail = ({ data }) => {
    return (
        <div className='flex flex-col items-center text-2xl gap-2 bg-cyan-800 text-white rounded shadow p-1'>
            ...
            <div className='p-4 bg-cyan-950 w-full flex flex-col items-center justify-center rounded-sm'>
            ...
            <img src={`https://openweathermap.org/img/wn/${data.weather[0].icon}@2x.png`} alt='' className='w-24 h-24' />
        </div>
    );
}
